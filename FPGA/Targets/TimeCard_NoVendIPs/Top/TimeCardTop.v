...
wire Clk_TxScl_t;
  ...
  //*************************************************************************************
  always @(negedge Mhz50RstN_Rst, posedge Mhz50Clk_Clk) begin
  ...
  always @(negedge Mhz62_5RstN_Rst, posedge Mhz62_5Clk_Clk) begin
